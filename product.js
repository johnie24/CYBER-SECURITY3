...
var reg = /\\|\/|\?|\ï¼Ÿ|\*|\"|\â€œ|\â€|\'|\â€˜|\â€™|\<|\>|\{|\}|\[|\]|\ã€|\ã€‘|\ï¼š|\:|\ã€|\^|\$|\!|\~|\`|\||\./g;
temp = '';
...
var myDate = new Date;
var year = myDate.getUTCFullYear(); //èŽ·å–å½“å‰å¹´
var mon = myDate.getUTCMonth() + 1; //èŽ·å–å½“å‰æœˆ
var date = myDate.getUTCDate(); //èŽ·å–å½“å‰æ—¥
